...
function MarkerClusterComponent({
    ...
    useEffect(() => {
        if (!map || !(map as any).addLayer) return; // Skip in test environment where addLayer may not exist
        
        // Check if markerClusterGroup is available (may not be in test environment)
                                    ...
                                    <Popup>
                                        <Box>
                                            ...
                                            {optimalLocation.participantCount !== undefined && (
                                                <Typography variant="body2" color="text.secondary">
                                                    Based
                                                    on {optimalLocation.participantCount} participant(s)
                                                </Typography>
                                            )}
                                            <Typography variant="body2" color="text.secondary"
                                                        sx={{mt: 0.5}}>
